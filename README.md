...
- For local testing, serve the folder over HTTP (e.g., `python -m http.server 3000`) and add `http://127.0.0.1:3000/` as a Redirect URI in Spotify while testing. Update `REDIRECT_URI` in `app.js` if you change hosts.
